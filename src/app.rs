    ...
    pub fn open_keybindings_popup(&mut self) {
        self.info_popup = Some(InfoPopup {
            ...
            lines: vec![
                ...
                "  2 / s / click    Statistics".to_string(),
                "  3 / i / click    Metadata".to_string(),
                String::new(),
                "File".to_string(),
                "  Ctrl+I           Import CSV → Parquet".to_string(),
                "  Ctrl+E           Export Parquet → CSV".to_string(),
                "  r                Refresh file list".to_string(),
                String::new(),
                "Tools".to_string(),
                "  Ctrl+P / Alt+T   Open palette".to_string(),
                String::new(),
                "General".to_string(),
